              ...
              Row(
                ...
                children: [
                  Text(
                    '''04.''',
                    style:
                        TextStyle(color: AppColors().neonColor, fontSize: 14, fontFamily: 'sfmono'),
                  ),
                  Text(
                    ''' What's next?''',
                    style:
                        TextStyle(color: AppColors().neonColor, fontSize: 16, fontFamily: 'sfmono'),
                  ),
                ],
              ),
              Padding(
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text('Check Out My Resume!',
                          style: TextStyle(
  ...
  showMessageDialog(context) {
    ...
    showDialog(
        ...
        builder: (_) => AlertDialog(
              ...
              titleTextStyle:
                  TextStyle(color: AppColors().neonColor, fontSize: 18, fontFamily: 'sfmono'),
              title: Row(
                children: [
                  ...
                  children: [
                                        ...
                                        if (_formKey.currentState!.validate()) {
                                          ...
                                          AppClass()
                                              .sendEmail(nameController.text,
                                                  contactInfoController.text, msgController.text)
                                              .then((value) {
                                            if (value) {
                                              Navigator.pop(context);
                                              AppClass().showSnackBar('Message sent successfully',
                                                  context: context);
                                            } else {
                                              Navigator.pop(context);
                                            ...
                                            Navigator.pop(context);
                                            AppClass()
                                                .showSnackBar('Error Occurred', context: context);
                                          });
                                        }
                                      },
                                      child: Container(
                    ...
                    Visibility(
                      ...
                      child: Container(
                          ...
                          color: Colors.transparent,
                          child: Center(
                              child: CircularProgressIndicator(color: AppColors().neonColor))),
                    ),
                  ],
                );
              }),
