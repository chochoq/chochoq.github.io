                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(Uri.parse("https://github.com/chochoq"));
                              },
                              onHover: (bol) {
                                if (bol) {
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(Uri.parse(
                                    "https://devchocho.notion.site/62ed7a92513f4cd983c9fd86586dc628"));
                              },
                              onHover: (bol) {
                                if (bol) {
                                  ref.read(hoverProvider.notifier).state = "notion";
                                } else {
                                  ref.read(hoverProvider.notifier).state = "";
                                }
                              },
                              child: Container(
                                margin: EdgeInsets.only(bottom: val == "notion" ? 5.0 : 0),
                                padding: const EdgeInsets.only(bottom: 8.0),
                                child: SvgPicture.asset('assets/svg/notion.svg',
                                    color: val == "notion"
                                        ? AppColors().neonColor
                                        : AppColors().textColor,
                                    width: 22),
